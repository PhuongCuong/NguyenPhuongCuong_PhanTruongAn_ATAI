        ...
        <View style={{ flex: 6, backgroundColor: "#FFF" }}>
            <View style={{ flex: 3, alignItems: "center", justifyContent: "space-around" }}>
                <View style={{ gap: 15 }}>
                    ...
                    <View style={{ width: 317, height: 50,justifyContent: "center",flexDirection:'row' }}>
                        <CheckBox style={{marginLeft:-10}}
                        checked={isChecked}
                        onPress={toggleCheck}  
                        size={25} checkedColor="black" uncheckedColor="black"
                        />
                        <Text style={{top:10,fontSize:15,color:'#717171'}}>Tôi đã đọc kỹ và đồng ý với các <Text style={{color:'blue'}}>Điều khoản sử dụng</Text> của ATAI</Text>
                    </View>
                </View>
